	...
	\draw[line width=2pt, color=lime, rotate around={#3:(#4,#5)}] (#4-#2/2, #5-#1/2) rectangle (#4+#2/2, #5+#1/2)  
    }
    ...
    \def\furnitureC[radius=#1](#2, #3){%
	    ...
	    \draw[line width=2pt, color=lime] (#2, #3) circle (#1)
    }
...
\node[furniture-label, text=lime ] at (26.0,34.5) {table};
\furnitureC[radius=10.0](30.0, 80.0);
\node[furniture-label, text=lime ] at (30.0,80.0) {table};
