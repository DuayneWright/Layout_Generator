	...
	\draw[line width=1pt, color=black, rotate around={#3:(#4,#5)}] (#4-#2/2, #5-#1/2) rectangle (#4+#2/2, #5+#1/2)  
    }
    ...
    \def\furnitureC[radius=#1](#2, #3){%
	    ...
	    \draw[line width=1pt, color=black] (#2, #3) circle (#1)
    }
    ...
    % Exterior walls
    \draw[wall, line width=50pt, color=black] (0.00,0.00) -- (0.00,100.00);
\draw[wall, line width=50pt, color=black] (0.00,100.00) -- (50.00,100.00);
\draw[wall, line width=50pt, color=black] (50.00,100.00) -- (50.00,125.00);
\draw[wall, line width=50pt, color=black] (50.00,125.00) -- (100.00,125.00);
\draw[wall, line width=50pt, color=black] (100.00,125.00) -- (100.00,75.00);
\draw[window,line width=1pt, color=black] (100.00,75.00) -- (100.00,25.00);
\draw[wall, line width=50pt, color=black] (100.00,25.00) -- (100.00,0.00);
\draw[wall, line width=50pt, color=black] (100.00,0.00) -- (75.00,0.00);
\draw[door, rotate around={-15.00:(75.00,0.00)}, line width=1.00pt, color=black] (75.00,0.00) -- ++(-50.00,0.00);
\draw[wall, line width=50pt, color=black] (25.00,0.00) -- (0.00,0.00);


    % Furniture
    \furnitureR[height=24.0, width=24.0, rotate=0.0](26.0, 34.5);
\node[furniture-label, text=black, scale=1.0] at (26.0,34.5) {table};
\furnitureC[radius=10.0](30.0, 80.0);
\node[furniture-label, text=black, scale=1.0] at (30.0,80.0) {table};


    % Cameras
    \camera[color=blue!75!black, rotate=90.0](72.0,72.0);
\node[camera-label,yshift=3pt,above,text=blue!75!black, scale=1.0] at (72.0,72.0) {Camera A};


    % Sensors
    \node[sensor, color=teal, scale=1.0](sensor) at (72.0,25.0) {};
\node[sensor-label,yshift=3pt,above,text=teal,scale=1.0] at (72.00,25.00) {Sesnor LW67746 \\ (72.00, 25.00)};

    
    % Calibrations
    \node[location, color=violet, scale=1.0](A1) at (72.0,100.0) {};
\node[location-label,yshift=3pt,above, text=violet, scale=1.0] at (A1) {A1};
