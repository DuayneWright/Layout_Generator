    ...
    \cfoot{}
    \rfoot{\textbf{\LARGE 2}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
    ...
    % Furniture
    \furnitureR[height=1.0, width=1.0, rotate=1.0](1.0, 1.0);
\node[furniture-label, text=black, scale=1.0, fill=none, inner sep=2pt] at (1.0,1.0) {1};
