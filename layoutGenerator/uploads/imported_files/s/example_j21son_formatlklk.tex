    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[scale=1/19.8,  % use this to reduce or enlargen the image on paper
                               x=1cm,
                               y=1cm,
    ...
    % Exterior walls
    \draw[wall, line width=5pt, color=black] (0.00,0.00) -- (0.00,100.00);
\draw[wall, line width=5pt, color=black] (0.00,100.00) -- (50.00,100.00);
\draw[wall, line width=5pt, color=black] (50.00,100.00) -- (50.00,125.00);
\draw[wall, line width=5pt, color=black] (50.00,125.00) -- (100.00,125.00);
\draw[wall, line width=5pt, color=black] (100.00,125.00) -- (100.00,75.00);
\draw[window,line width=1pt, color=black] (100.00,75.00) -- (100.00,25.00);
\draw[wall, line width=5pt, color=black] (100.00,25.00) -- (100.00,0.00);
\draw[wall, line width=5pt, color=black] (100.00,0.00) -- (75.00,0.00);
\draw[door, rotate around={-15.00:(75.00,0.00)}, line width=1.00pt, color=black] (75.00,0.00) -- ++(-50.00,0.00);
\draw[wall, line width=5pt, color=black] (25.00,0.00) -- (0.00,0.00);
...
\node[sensor-label,yshift=3pt,above,text=teal,scale=1.0] at (72.00,25.00) {Sensor LW67756 \\ (72.00, 25.00)};
