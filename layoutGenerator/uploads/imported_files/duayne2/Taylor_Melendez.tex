    ...
    \lhead{1985 October 25}
    \chead{}
    \rhead{\footnotesize \thepage \ {\color{gray} of \pageref{LastPage}}}

    \cfoot{}
    \rfoot{\textbf{\LARGE Jayme Humphrey}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
	...
	\begin{tabular}{l l}
		\makecell[lt]{
			\textbf{Location:}\\
     		Quidem qui qui autem Neighborhood \\
 		    Ea pariatur Et eum  Bldg, Still Hopes\\
           	1 Still Hopes Drive\\
