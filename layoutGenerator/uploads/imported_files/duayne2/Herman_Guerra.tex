    ...
    \lhead{1989 December 06}
    \chead{}
    \rhead{\footnotesize \thepage \ {\color{gray} of \pageref{LastPage}}}

    \cfoot{}
    \rfoot{\textbf{\LARGE Natalie Webster}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
	...
	\begin{tabular}{l l}
		\makecell[lt]{
			\textbf{Location:}\\
     		Natus ipsa sit num Neighborhood \\
 		    Aliquam veritatis co Bldg, Still Hopes\\
           	1 Still Hopes Drive\\
