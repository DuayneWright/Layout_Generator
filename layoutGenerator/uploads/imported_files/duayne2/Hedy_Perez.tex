    ...
    \cfoot{}
    \rfoot{\textbf{\LARGE Andrew Bright}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
	...
	\begin{tabular}{l l}
		\makecell[lt]{
			\textbf{Location:}\\
     		Eu velit quia pariat Neighborhood \\
 		    Lorem aut quae et pa Bldg, Still Hopes\\
           	1 Still Hopes Drive\\
