    ...
    \lhead{1975 December 30}
    \chead{}
    \rhead{\footnotesize \thepage \ {\color{gray} of \pageref{LastPage}}}

    \cfoot{}
    \rfoot{\textbf{\LARGE Candice Ortiz}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
    ...
    % Exterior walls
    \draw[door, rotate around={15.00:(12.00,12.00)}, line width=1.00pt, color=black] (12.00,12.00) -- ++(-12.00,0.00);
    ...
    % Cameras
    \camera[color=blue!75!black,rotate=0.0, inner sep=0.5mm](-32.8,12.8);
\camera[color=blue!75!black,rotate=0.0, inner sep=0.5mm](25.45,10.36);
	...
	\begin{tabular}{l l}
		\makecell[lt]{
			\textbf{Location:}\\
     		In voluptas commodo  Neighborhood \\
 		    Consectetur qui volu Bldg, Still Hopes\\
           	1 Still Hopes Drive\\
