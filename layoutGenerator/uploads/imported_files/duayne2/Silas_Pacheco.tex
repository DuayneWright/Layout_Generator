    ...
    \lhead{1994 November 24}
    \chead{}
    \rhead{\footnotesize \thepage \ {\color{gray} of \pageref{LastPage}}}

    \cfoot{}
    \rfoot{\textbf{\LARGE Macy Barrera}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
    ...
    % Cameras
    \camera[color=blue!75!black,rotate=90.0, inner sep=7.5mm](-3.8,-5.91);
	...
	\begin{tabular}{l l}
		\makecell[lt]{
			\textbf{Location:}\\
     		Porro obcaecati eos Neighborhood \\
 		    Odio id sequi recusa Bldg, Still Hopes\\
           	1 Still Hopes Drive\\
