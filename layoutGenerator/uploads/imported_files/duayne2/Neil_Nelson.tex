    ...
    \lhead{2012 October 07}
    \chead{}
    \rhead{\footnotesize \thepage \ {\color{gray} of \pageref{LastPage}}}

    \cfoot{}
    \rfoot{\textbf{\LARGE Armando Levy}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
    ...
    % Cameras
    \camera[color=blue!75!black,rotate=0.0, inner sep=0.5mm](1.7,17.09);


    % Sensors
    \node[sensor, color=teal, scale=11.0, inner sep=0.5mm](sensor) at (4.2,45.84) {};

    
    % Calibrations
    \node[location, color=violet, scale=11.0, inner sep=0.5mm]( ) at (3.95,29.59) {};
	...
	\begin{tabular}{l l}
		\makecell[lt]{
			\textbf{Location:}\\
     		Incididunt excepteur Neighborhood \\
 		    In sit rerum quo do Bldg, Still Hopes\\
           	1 Still Hopes Drive\\
