    ...
    \cfoot{}
    \rfoot{\textbf{\LARGE Alexa Phillips}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
    ...
    % Cameras
    \camera[color=blue!75!black,rotate=0.0, inner sep=0.5mm](12.0,12.0);


    % Sensors
    \node[sensor, color=teal, scale=1.0, inner sep=0.5mm](sensor) at (12.0,-12.0) {};

    
    % Calibrations
    \node[location, color=violet, scale=1.0, inner sep=0.5mm]( ) at (-12.0,12.0) {};
	...
	\begin{tabular}{l l}
		\makecell[lt]{
			\textbf{Location:}\\
     		Aut et voluptatem S Neighborhood \\
 		    Ex placeat dignissi Bldg, Still Hopes\\
           	1 Still Hopes Drive\\
