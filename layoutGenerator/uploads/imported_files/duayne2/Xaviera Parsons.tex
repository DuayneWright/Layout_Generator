    ...
    \lhead{1983 January 04}
    \chead{}
    \rhead{\footnotesize \thepage \ {\color{gray} of \pageref{LastPage}}}

    \cfoot{}
    \rfoot{\textbf{\LARGE Jane Tate}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[scale=1/2.0,  % use this to reduce or enlargen the image on paper
                               x=1cm,
                               y=1cm,
    ...
    % Room Navigation
    \draw[nav-arrow,color=green!60!black,{Stealth[scale=1.0]}-] (-12.0,0.25) -- ++(-12.0,-1.4695761589768238e-15);
	...
	\begin{tabular}{l l}
		\makecell[lt]{
			\textbf{Location:}\\
     		Incidunt ipsum inci Neighborhood \\
 		    Veniam quia culpa  Bldg, Still Hopes\\
           	1 Still Hopes Drive\\
