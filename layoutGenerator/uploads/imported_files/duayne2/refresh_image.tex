	...
	\draw[line width=5pt, color=black, rotate around={#3:(#4,#5)}] (#4-#2/2, #5-#1/2) rectangle (#4+#2/2, #5+#1/2)  
    }
    ...
    \def\furnitureC[radius=#1](#2, #3){%
	    ...
	    \draw[line width=5pt, color=black] (#2, #3) circle (#1)
    }
...
\node[location-label,xshift=6pt,right, scale=1.0, text=violet] at (A1) {A1};
\node[location-label,xshift=-6pt,left, scale=1.0, text=violet] at (A1) {A1};
\node[location-label,yshift=-6pt,below, scale=1.0, text=violet] at (A1) {A1};
