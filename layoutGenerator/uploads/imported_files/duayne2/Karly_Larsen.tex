    ...
    \lhead{1992 August 14}
    \chead{}
    \rhead{\footnotesize \thepage \ {\color{gray} of \pageref{LastPage}}}

    \cfoot{}
    \rfoot{\textbf{\LARGE Xanthus Washington}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
	...
	\begin{tabular}{l l}
		\makecell[lt]{
			\textbf{Location:}\\
     		Est voluptatibus du Neighborhood \\
 		    Aut cupidatat volupt Bldg, Still Hopes\\
           	1 Still Hopes Drive\\
