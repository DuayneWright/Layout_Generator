...
\draw[wall, line width=9pt,color =black] (0.00,0.00) -- (0.00,100.00) coordinate (c);
\draw[wall, line width=9pt,color =black] (0.00,100.00) -- (50.00,100.00) coordinate (c);
\draw[wall, line width=9pt,color =black] (50.00,100.00) -- (50.00,125.00) coordinate (c);
\draw[wall, line width=9pt,color =black] (50.00,125.00) -- (100.00,125.00) coordinate (c);
\draw[wall, line width=9pt,color =black] (100.00,125.00) -- (100.00,75.00) coordinate (c);
\draw[wall, line width=9pt,color =black] (100.00,75.00) -- (100.00,75.00) coordinate (c);
...
\draw[wall, line width=9pt,color =black] (100.00,25.00) -- (100.00,0.00) coordinate (c);
\draw[wall, line width=9pt,color =black] (100.00,0.00) -- (75.00,0.00) coordinate (c);
\draw[wall, line width=9pt,color =black] (75.00,0.00) -- (75.00,0.00) coordinate (c);
\draw[door, rotate around={10.00:(75.00,0.00)}, line width=2pt, color=black] (75.00,0.00) -- ++(-50.00,0.00);
\draw[wall, line width=9pt,color =black] (25.00,0.00) -- (0.00,0.00) coordinate (c);
\draw[wall, line width=9pt,color =black] (0.00,0.00) -- (0.00,0.00) coordinate (c);
