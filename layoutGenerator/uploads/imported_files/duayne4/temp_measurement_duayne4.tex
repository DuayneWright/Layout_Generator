    ...
    \cfoot{}
    \rfoot{\textbf{\LARGE May Wallace}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
    ...
    \begin{figure}[H]
        ...
        \foreach \i in {0.0,24.0,...,24.0}{
            \draw[grid-line] (-5.0,\i) -- (53.0,\i);
            \tikzmath{int \value; \value = \i;};
            \node[gray, left] at (-5.0,\i) {\SI{\value}{\inch}};
        }
    

    \draw[wall, line width=2pt, color=black] (32.00,11.00) -- (2.00,23.00);
\draw[wall, line width=2pt, color=black] (23.00,21.00) -- (23.00,12.00);
\draw[wall, line width=2pt, color=black] (2.00,23.00) -- (2.00,23.00);
	...
	\begin{tabular}{l l}
		\makecell[lt]{
			\textbf{Location:}\\
     		At odio anim fugiat  Neighborhood \\
 		    Voluptatem dicta fug Bldg, Still Hopes\\
           	1 Still Hopes Drive\\
