    ...
    \cfoot{}
    \rfoot{\textbf{\LARGE asasa}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
    ...
    % Furniture
    \furnitureR[height=12.0, width=2.0, rotate=2.0](1.0, 1.0);
\node[furniture-label, text=black, scale=2.0, fill=none, inner sep=2pt] at (1.0,1.0) {sa};
