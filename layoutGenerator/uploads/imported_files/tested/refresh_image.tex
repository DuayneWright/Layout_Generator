    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[scale=0.07692307692307693,  % use this to reduce or enlargen the image on paper
    ...
    \node[location, color=violet](A1) at (72.0,100.0) {};
\node[location-label,above,yshift=3pt, text=violet] at (A1) {A1};
\camera[color=blue!75!black,rotate=90.0](72.0,72.0);
\node[camera-label,yshift=3pt,above, text=blue!75!black] at (72.0,72.0) {Camera A};
\node[sensor, color=teal](sensor) at (72.0,25.0) {};
\node[sensor-label,yshift=3pt,above,text=teal] at (72.00,25.00) {Sesnor LW67746 \\ (72.00, 25.00)};
...
\draw[wall, line width=2pt,color =black] (0.00,100.00) -- (0.00,100.00) coordinate (c);
\draw[wall, line width=2pt,color =black] (0.00,100.00) -- (50.00,100.00) coordinate (c);
\draw[wall, line width=2pt,color =black] (50.00,100.00) -- (50.00,100.00) coordinate (c);
\draw[wall, line width=2pt,color =black] (50.00,100.00) -- (50.00,125.00) coordinate (c);
\draw[wall, line width=2pt,color =black] (50.00,125.00) -- (50.00,125.00) coordinate (c);
\draw[wall, line width=2pt,color =black] (50.00,125.00) -- (100.00,125.00) coordinate (c);
\draw[wall, line width=2pt,color =black] (100.00,125.00) -- (100.00,125.00) coordinate (c);
...
\draw[wall, line width=2pt,color =black] (100.00,0.00) -- (100.00,0.00) coordinate (c);
...
\draw[door, rotate around={345.00:(75.00,0.00)}, line width=1pt, color=black] (75.00,0.00) -- ++(-50.00,0.00);
...
\draw[nav-arrow,color=green!60!black] (125.0,25.0) -- ++(12,0) node[right, fill=white] {room};
