    ...
    \begin{figure}[H]
        ...
        %% GRID - X
        \foreach \i in {0.0,24.0,...,216.0}{
            \draw[grid-line] (\i,-5.0) -- (\i,221.0);
        ...
        %% GRID - Y
        \foreach \i in {0.0,24.0,...,216.0}{
            \draw[grid-line] (-5.0,\i) -- (221.0,\i);
            \tikzmath{int \value; \value = \i;};
            \node[gray, left] at (-5.0,\i) {\SI{\value}{\inch}};
        }
    

    \draw[wall, line width=2pt, color=black] (10.00,10.00) -- (200.00,200.00);
\draw[door, rotate around={189.00:(10.00,10.00)}, line width=1.00pt, color=black] (10.00,10.00) -- ++(-10.00,0.00);
