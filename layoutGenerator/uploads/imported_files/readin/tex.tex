    ...
    \lhead{1970 October 21}
    \chead{}
    \rhead{\footnotesize \thepage \ {\color{gray} of \pageref{LastPage}}}

    \cfoot{}
    \rfoot{\textbf{\LARGE Portia Stevenson}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
    ...
    \node[location, color=violet, scale=1.0](ca) at (1.0,22.0) {};
\node[location-label, text=violet, scale=1.0] at (ca) {ca};
\furnitureC[radius=2.0](12.0, 12.0);
\node[furniture-label, text=black, scale=1.0] at (12.0,12.0) {circle2};
	...
	\begin{tabular}{l l}
		\makecell[lt]{
			\textbf{Location:}\\
     		Vel aut commodi in i Neighborhood \\
 		    Incididunt velit sun Bldg, Still Hopes\\
           	1 Still Hopes Drive\\
