    ...
    \lhead{2012 October 16}
    \chead{}
    \rhead{\footnotesize \thepage \ {\color{gray} of \pageref{LastPage}}}

    \cfoot{}
    \rfoot{\textbf{\LARGE Darrel Garza}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
    ...
    \begin{figure}[H]
        ...
        %% GRID - Y
        \foreach \i in {0.0,24.0,...,24.0}{
            \draw[grid-line] (-5.0,\i) -- (29.0,\i);
            \tikzmath{int \value; \value = \i;};
            \node[gray, left] at (-5.0,\i) {\SI{\value}{\inch}};
        }
    

    \node[sensor, color=teal, scale=1.0](sensor) at (12.0,12.0) {};
\node[sensor-label,text=teal,scale=1.0] at (12.00,12.00) {sens \\ (12.00, 12.00)};
\furnitureC[radius=5.0](12.0, 12.0);
\node[furniture-label, text=black, scale=1.0] at (12.0,12.0) {circle};
	...
	\begin{tabular}{l l}
		\makecell[lt]{
			\textbf{Location:}\\
     		Exercitationem asper Neighborhood \\
 		    Laboriosam laboris  Bldg, Still Hopes\\
           	1 Still Hopes Drive\\
