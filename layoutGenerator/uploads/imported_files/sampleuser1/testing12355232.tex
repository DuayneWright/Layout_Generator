	...
	\draw[line width=2pt, color=purple, rotate around={#3:(#4,#5)}] (#4-#2/2, #5-#1/2) rectangle (#4+#2/2, #5+#1/2)  
    }
    ...
    \def\furnitureC[radius=#1](#2, #3){%
	    ...
	    \draw[line width=2pt, color=purple] (#2, #3) circle (#1)
    }
...
\node[sensor, color=brown](sensor) at (72.0,25.0) {};
\node[sensor-label,yshift=3pt,above,text=brown] at (72.00,25.00) {Sesnor LW67746 \\ (72.00, 25.00)};
\furnitureR[height=24.0, width=24.0, rotate=0.0](26.0, 34.5);
\node[furniture-label, text=purple ] at (26.0,34.5) {table};
\furnitureC[radius=10.0](30.0, 80.0);
\node[furniture-label, text=purple ] at (30.0,80.0) {table};
