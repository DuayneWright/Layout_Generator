    ...
    \node[location, color=black, scale=1.0](A1) at (72.0,100.0) {};
\node[location-label, text=black, scale=1.0] at (A1) {A1};
\camera[color=black,rotate=90.0](72.0,72.0);
\node[camera-label, text=black, scale=1.0] at (72.0,72.0) {Camera A};
\node[sensor, color=black, scale=1.0](sensor) at (72.0,25.0) {};
\node[sensor-label,text=black,scale=1.0] at (72.00,25.00) {Sesnor LW67746 \\ (72.00, 25.00)};
...
\draw[nav-arrow,color=black,{Stealth[scale=1.0]}-] (125.0,25.0) -- ++(12,0) node[right, fill=white] {room};
