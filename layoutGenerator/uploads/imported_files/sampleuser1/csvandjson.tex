    ...
    \lhead{2025 February 01}
    \chead{}
    \rhead{\footnotesize \thepage \ {\color{gray} of \pageref{LastPage}}}

    \cfoot{}
    \rfoot{\textbf{\LARGE n}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
    ...
    \draw[wall, line width=2pt, color=black] (1.00,1.00) -- (100.00,100.00);
