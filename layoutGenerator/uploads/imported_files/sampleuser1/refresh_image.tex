    ...
    \lhead{2025 February 05}
    \chead{}
    \rhead{\footnotesize \thepage \ {\color{gray} of \pageref{LastPage}}}

    \cfoot{}
    \rfoot{\textbf{\LARGE w}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[scale=1/13.2,  % use this to reduce or enlargen the image on paper
                               x=1cm,
                               y=1cm,
    ...
    \draw[wall, line width=2pt, color=magenta] (10.00,100.00) -- (0.00,200.00);
