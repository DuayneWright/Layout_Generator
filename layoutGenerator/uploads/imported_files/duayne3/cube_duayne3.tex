    ...
    \lhead{1970 December 14}
    \chead{}
    \rhead{\footnotesize \thepage \ {\color{gray} of \pageref{LastPage}}}

    \cfoot{}
    \rfoot{\textbf{\LARGE Amir Witt}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
    ...
    \begin{figure}[H]
        ...
        %% GRID - X
        \foreach \i in {0.0,36.0,...,144.0}{
            \draw[grid-line] (\i,-5.0) -- (\i,185.0);
    ...
    \draw[wall, line width=2pt, color=black] (13.00,0.00) -- (0.00,0.00);
\draw[wall, line width=2pt, color=black] (0.00,0.00) -- (0.00,170.00);
\draw[wall, line width=2pt, color=black] (0.00,170.00) -- (115.00,170.00);
\draw[wall, line width=2pt, color=black] (115.00,170.00) -- (115.00,0.00);
\draw[wall, line width=2pt, color=black] (115.00,0.00) -- (99.00,0.00);
	...
	\begin{tabular}{l l}
		\makecell[lt]{
			\textbf{Location:}\\
     		Harum ex aut quia qu Neighborhood \\
 		    Ipsam atque accusant Bldg, Still Hopes\\
           	1 Still Hopes Drive\\
