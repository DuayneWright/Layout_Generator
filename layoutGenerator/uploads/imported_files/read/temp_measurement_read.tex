    ...
    \cfoot{}
    \rfoot{\textbf{\LARGE Kamal Sparks}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
    ...
    \node[location, color=violet, scale=1.0](ca) at (12.0,12.0) {};
\node[location-label, text=violet, scale=1.0] at (ca) {ca};
	...
	\begin{tabular}{l l}
		\makecell[lt]{
			\textbf{Location:}\\
     		Magni quod voluptas  Neighborhood \\
 		    Officiis facilis fac Bldg, Still Hopes\\
           	1 Still Hopes Drive\\
