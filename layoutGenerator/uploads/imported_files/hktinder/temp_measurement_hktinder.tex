    ...
    \lhead{0011 November 11}
    \chead{}
    \rhead{\footnotesize \thepage \ {\color{gray} of \pageref{LastPage}}}

    \cfoot{}
    \rfoot{\textbf{\LARGE helo}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
    ...
    \begin{figure}[H]
        ...
        %% GRID - X
        \foreach \i in {-180.0,-144.0,...,180.0}{
        ...
        \foreach \i in {-36.0,0.0,...,288.0}{
            \draw[grid-line] (-185.0,\i) -- (185.0,\i);
            \tikzmath{int \value; \value = \i;};
            \node[gray, left] at (-185.0,\i) {\SI{\value}{\inch}};
        }
