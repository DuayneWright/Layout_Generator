	...
	\draw[line width=5pt, color=gray, rotate around={#3:(#4,#5)}] (#4-#2/2, #5-#1/2) rectangle (#4+#2/2, #5+#1/2)  
    }
    ...
    \def\furnitureC[radius=#1](#2, #3){%
	    ...
	    \draw[line width=5pt, color=gray] (#2, #3) circle (#1)
    }
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[scale=1/13,  % use this to reduce or enlargen the image on paper
    ...
    \node[location, color=violet, scale=1.0](A1) at (72.0,100.0) {};
\node[location-label, text=violet, scale=1.0] at (A1) {A1};
\camera[color=blue!75!black,scale=1.0, rotate=90.0](72.0,72.0);
\node[camera-label, text=blue!75!black, scale=1.0] at (72.0,72.0) {Camera A};
\node[sensor, color=teal, scale=1.0](sensor) at (72.0,25.0) {};
\node[sensor-label,text=teal,scale=1.0] at (72.00,25.00) {Sesnor LW67746 \\ (72.00, 25.00)};
\furnitureR[height=24.0, width=24.0, rotate=0.0](26.0, 34.5);
\node[furniture-label, text=gray, scale=1.0] at (26.0,34.5) {table};
\furnitureC[radius=10.0](30.0, 80.0);
\node[furniture-label, text=gray, scale=1.0] at (30.0,80.0) {table};
\draw[wall, line width=10pt, color=pink] (0.00,0.00) -- (0.00,100.00);
\draw[wall, line width=10pt, color=pink] (0.00,100.00) -- (50.00,100.00);
\draw[wall, line width=10pt, color=pink] (50.00,100.00) -- (50.00,125.00);
\draw[wall, line width=10pt, color=pink] (50.00,125.00) -- (100.00,125.00);
\draw[wall, line width=10pt, color=pink] (100.00,125.00) -- (100.00,75.00);
\draw[window,line width=2pt, color=white] (100.00,75.00) -- (100.00,25.00);
\draw[wall, line width=10pt, color=pink] (100.00,25.00) -- (100.00,0.00);
\draw[wall, line width=10pt, color=pink] (100.00,0.00) -- (75.00,0.00);
\draw[door, rotate around={-15.00:(75.00,0.00)}, line width=1.00pt, color=green] (75.00,0.00) -- ++(-50.00,0.00);
\draw[wall, line width=10pt, color=pink] (25.00,0.00) -- (0.00,0.00);
\draw[nav-arrow,color=green!60!black,{Stealth[scale=1.0]}-] (125.0,25.0) -- ++(12,0) node[right, fill=white] {room};
