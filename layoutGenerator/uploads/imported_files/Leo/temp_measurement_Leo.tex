    ...
    \cfoot{}
    \rfoot{\textbf{\LARGE Walker Tate}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
    ...
    \begin{figure}[H]
        ...
        %% GRID - Y
        \foreach \i in {0.0,24.0,...,72.0}{
            \draw[grid-line] (-5.0,\i) -- (77.0,\i);
            \tikzmath{int \value; \value = \i;};
            \node[gray, left] at (-5.0,\i) {\SI{\value}{\inch}};
        }
    

    \draw[wall, line width=5pt, color=pink] (0.00,0.00) -- (69.00,69.00);
\draw[wall, line width=5pt, color=pink] (0.00,69.00) -- (69.00,0.00);
	...
	\begin{tabular}{l l}
		\makecell[lt]{
			\textbf{Location:}\\
     		Vero voluptas suscip Neighborhood \\
 		    Dolorem dolorem reru Bldg, Still Hopes\\
           	1 Still Hopes Drive\\
