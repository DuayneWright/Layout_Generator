    ...
    \lhead{2012 October 29}
    \chead{}
    \rhead{\footnotesize \thepage \ {\color{gray} of \pageref{LastPage}}}

    \cfoot{}
    \rfoot{\textbf{\LARGE Cole Holder}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
...
\node[sensor, color=teal, scale=1.0, inner sep=12.5mm](sensor) at (22.96,26.65) {};
	...
	\begin{tabular}{l l}
		\makecell[lt]{
			\textbf{Location:}\\
     		Pariatur Tempore i Neighborhood \\
 		    Consequat Nemo face Bldg, Still Hopes\\
           	1 Still Hopes Drive\\
