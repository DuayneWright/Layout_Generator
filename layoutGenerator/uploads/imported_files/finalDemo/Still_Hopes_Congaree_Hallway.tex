    ...
    \cfoot{}
    \rfoot{\textbf{\LARGE C}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
    ...
    % Exterior walls
    \draw[wall, line width=2pt, color=black] (-64.50,52.25) -- (-64.50,-69.00);
\draw[wall, line width=2pt, color=black] (-64.50,-69.00) -- (70.75,-69.00);
\draw[wall, line width=2pt, color=black] (70.75,-69.00) -- (70.75,53.25);
\draw[wall, line width=2pt, color=black] (70.75,53.02) -- (31.50,53.25);
\draw[wall, line width=2pt, color=black] (31.75,53.02) -- (31.50,8.25);
\draw[wall, line width=2pt, color=black] (31.75,8.22) -- (-33.50,8.25);
\draw[wall, line width=2pt, color=black] (-32.51,8.22) -- (-32.75,53.00);
\draw[wall, line width=2pt, color=black] (-32.51,52.76) -- (-59.75,68.50);


    % Furniture
    \furnitureC[radius=3.75](-15.79, -37.4);
\furnitureR[height=7.5, width=7.5, rotate=0.0](16.71, -37.15);


    % Cameras
    \camera[color=blue!75!black,rotate=0.0, inner sep=2.610698358693317mm](61.59,-55.15);


    % Sensors
    \node[sensor, color=teal, scale=1.0, inner sep=2.507826426674347mm](sensor) at (51.95,45.35) {};

    
    % Calibrations
    \node[location, color=violet, scale=1.0, inner sep=3.411924968650033mm]( ) at (-24.79,-9.65) {};
\node[location, color=violet, scale=1.0, inner sep=3.409365151608429mm]( ) at (-5.29,-11.9) {};


    % Room Navigation
    \draw[nav-arrow,color=green!60!black,{Stealth[scale=1.0]}-] (-46.25,49.0) -- ++(-7.715274834628325e-15,-42.0);
