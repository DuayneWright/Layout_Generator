    ...
    \lhead{1973 February 14}
    \chead{}
    \rhead{\footnotesize \thepage \ {\color{gray} of \pageref{LastPage}}}

    \cfoot{}
    \rfoot{\textbf{\LARGE }\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
    ...
    \node[location, color=violet, scale=1.0](wdw) at (12.0,12.0) {};
\node[location-label, text=violet, scale=1.0] at (wdw) {wdw};
\furnitureC[radius=12.0](12.0, 12.0);
\node[furniture-label, text=black, scale=1.0] at (12.0,12.0) {dwd};
	...
	\begin{tabular}{l l}
		\makecell[lt]{
			\textbf{Location:}\\
     		Sint commodo id nequ Neighborhood \\
 		    Vero dolor numquam q Bldg, Still Hopes\\
           	1 Still Hopes Drive\\
