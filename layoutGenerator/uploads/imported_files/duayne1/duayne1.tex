    ...
    \node[location, color=violet, scale=1.0](L1) at (12.0,12.0) {};
\node[location-label, text=violet, scale=1.0] at (L1) {L1};
\furnitureC[radius=3.0](11.0, 11.0);
\node[furniture-label, text=black, scale=1.0] at (11.0,11.0) {circles};
	...
	\begin{tabular}{l l}
		\makecell[lt]{
			\textbf{Location:}\\
     		Non culpa reprehend Neighborhood \\
 		    Dolores omnis velit  Bldg, Still Hopes\\
           	1 Still Hopes Drive\\
