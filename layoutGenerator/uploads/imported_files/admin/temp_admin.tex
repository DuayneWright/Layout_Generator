    ...
    \lhead{2024 December 04}
    \chead{}
    \rhead{\footnotesize \thepage \ {\color{gray} of \pageref{LastPage}}}

    \cfoot{}
    \rfoot{\textbf{\LARGE Test}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
    ...
    \draw[wall, line width=2pt,color =black] (0.00,0.00) -- (30.00,30.00) coordinate (c);
\draw[wall, line width=2pt,color =black] (30.00,30.00) -- (30.00,30.00) coordinate (c);
