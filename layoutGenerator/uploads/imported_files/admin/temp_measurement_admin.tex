    ...
    \lhead{2024 December 18}
    \chead{}
    \rhead{\footnotesize \thepage \ {\color{gray} of \pageref{LastPage}}}

    \cfoot{}
    \rfoot{\textbf{\LARGE wef}\\\vspace{3pt}{\large\color{gray}NIH STTR Phase II}}
    ...
    \draw[wall, line width=2pt, color=black] (12.00,45.00) -- (12.00,3.00) coordinate (c);
\draw[wall, line width=2pt, color=black] (12.00,3.00) -- (12.00,3.00) coordinate (c);
